...
import 'package:s_m_system/TeacherSignIn.dart';
import 'Profile.dart';
...
class _TeacherHomePageState extends State<TeacherHomePage> {
  ...
  String name, Id, morning1, morning2, noon1, noon2, sub1, sub2, sub3, sub4;
            ...
            children: [
              ...
              TabBar(labelColor: Colors.blueAccent,
                tabs: [
                  ...
                  Tab(icon: Icon(Icons.note),text: "All Student Info"),
                ],
              ),
              Expanded(
                child: TabBarView(
                            ...
                            return Card(
                              child: Padding(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Text("Name: " + document['SName'] ?? "0.0"),
                                    Divider(),
                                    SizedBox(width: 30,),
                                    Text("Semester: " +document['Semester'] ?? "0.0"),
                                    SizedBox(width: 30,),
                                    Text("Result: " +document['Result'] ?? "0.0"),
                                  ],
                                ),
                              ),
                            );
